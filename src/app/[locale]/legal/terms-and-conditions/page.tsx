  ...
  return (
    <>
      <VStack marginBlock="10">
        ...
        <span>Updated at 2023-11-22</span>
        <p>
      ...
      <Accordion>
        <AccordionItem>
          ...
          <AccordionItemContent>
            ...
            <ul>
              <li>
                Cookie:Â small amount of data generated by a website and saved
        ...
        <AccordionItem>
          <AccordionItemToggle>Restrictions</AccordionItemToggle>
          <AccordionItemContent>
            ...
            <ul>
              ...
              <li>
                ...
                notice of copyright or trademark) of Kinguru or its affiliates,
        ...
        <AccordionItem>
          <AccordionItemToggle>Return and Refund Policy</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              Thanks for shopping at Kinguru. We appreciate the fact that you
              ...
              are terms and conditions that apply to transactions at Kinguru.
              ...
              Kinguru, you agree to the terms along with Kinguru's Privacy
              Policy. If, for any reason, You are not completely satisfied with
              any good or service that we provide, don't hesitate to contact us
        ...
        <AccordionItem>
          <AccordionItemToggle>Your Suggestions</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              Any feedback, comments, ideas, improvements or suggestions
              (collectively, "Suggestions") provided by you to Kinguru with
              respect to the website shall remain the sole and exclusive
              property of Kinguru. Kinguru shall be free to use, copy, modify,
        ...
        <AccordionItem>
          ...
          <AccordionItemContent>
            <p>
              We've updated our Terms & ConditionsÂ to provide you with complete
        ...
        <AccordionItem>
          <AccordionItemToggle>Links to Other Websites</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              ...
              that websites own rules and policies. Such third parties may use
        ...
        <AccordionItem>
          <AccordionItemToggle>Cookies</AccordionItemToggle>
          <AccordionItemContent>
            <p>
        ...
        <AccordionItem>
          ...
          <AccordionItemContent>
            <p>
              You acknowledge and agree that Kinguru may stop (permanently or
              ...
              You do not need to specifically inform Kinguru when you stop using
              the Service. You acknowledge and agree that if Kinguru disables
        ...
        <AccordionItem>
          ...
          <AccordionItemContent>
            <p>
              Kinguru reserves the right to modify, suspend or discontinue,
        ...
        <AccordionItem>
          <AccordionItemToggle>Updates to Our website</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              Kinguru may from time to time provide enhancements or improvements
              ...
              functionalities of the website. You agree that Kinguru has no
              ...
              website to you. You further agree that all Updates will be (i)
              deemed to constitute an integral part of the website, and (ii)
              subject to the terms and conditions of this Agreement.
            </p>
          </AccordionItemContent>
        </AccordionItem>
        <AccordionItem>
          <AccordionItemToggle>Third-Party Services</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              ...
              ("Third- Party Services"). You acknowledge and agree that Kinguru
              ...
              thereof. Kinguru does not assume and shall not have any liability
        ...
        <AccordionItem>
          <AccordionItemToggle>Term and Termination</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              This Agreement shall remain in effect until terminated by you or
              Kinguru. Kinguru may, in its sole discretion, at any time and for
              ...
              without prior notice from Kinguru, in the event that you fail to
              ...
              not limit any of Kinguru's rights or remedies at law or in equity
        ...
        <AccordionItem>
          ...
          <AccordionItemContent>
            <p>
              If you are a copyright owner or such ownerâ€™s agent and believe
        ...
        <AccordionItem>
          <AccordionItemToggle>Indemnification</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              You agree to indemnify and hold Kinguru and its parents,
        ...
        <AccordionItem>
          ...
          <AccordionItemContent>
            <p>
              ...
              limitation to the foregoing, Kinguru provides no warranty or
              ...
              neither Kinguru nor any Kinguru's provider makes any
              representation or warranty of any kind, express or implied: (i) as
              to the operation or availability of the website, or the
              information, content, and materials or products included thereon;
              (ii) that the website will be uninterrupted or error-free; (iii)
              as to the accuracy, reliability, or currency of any information or
              content provided through the website; or (iv) that the website,
              its servers, the content, or e-mails sent from or on behalf of
              Kinguru are free of viruses, scripts, trojan horses, worms,
        ...
        <AccordionItem>
          <AccordionItemToggle>Limitation of Liability</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              Notwithstanding any damages that you might incur, the entire
              liability of Kinguru and any of its suppliers under any provision
              ...
              no event shall Kinguru or its suppliers be liable for any special,
              ...
              even if Kinguru or any supplier has been advised of the
        ...
        <AccordionItem>
          <AccordionItemToggle>Severability</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              ...
              Kinguru on the Services, shall constitute the entire agreement
              between you and Kinguru concerning the Services. If any provision
              ...
              such term or any other term, and Kinguru's failure to assert any
              right or provision under this Agreement shall not constitute a
              waiver of such right or provision. YOU AND Kinguru AGREE THAT ANY
        ...
        <AccordionItem>
          <AccordionItemToggle>Waiver</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              ...
              a breach constitute waiver of any subsequent breach. o failure to
        ...
        <AccordionItem>
          ...
          <AccordionItemContent>
            <p>
              Kinguru reserves the right, at its sole discretion, to modify or
              ...
              you are no longer authorized to use Kinguru.
            </p>
          </AccordionItemContent>
        </AccordionItem>
        <AccordionItem>
          <AccordionItemToggle>Entire Agreement</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              The Agreement constitutes the entire agreement between you and
              Kinguru regarding your use of the website and supersedes all prior
              and contemporaneous written or oral agreements between you and
              Kinguru. You may be subject to additional terms and conditions
              that apply when you use or purchase other Kinguru's services,
              which Kinguru will provide to you at the time of such use or
              purchase.
            </p>
          </AccordionItemContent>
        </AccordionItem>
        <AccordionItem>
          <AccordionItemToggle>Updates to Our Terms</AccordionItemToggle>
          <AccordionItemContent>
            <p>
        ...
        <AccordionItem>
          <AccordionItemToggle>Intellectual Property</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              The website and its entire contents, features and functionality
              (including but not limited to all information, software, text,
              displays, images, video and audio, and the design, selection and
              arrangement thereof), are owned by Kinguru, its licensors or other
              ...
              permission of Kinguru, unless and except as is expressly provided
              in these Terms & Conditions. Any unauthorized use of the material
              is prohibited.
            </p>
          </AccordionItemContent>
        </AccordionItem>
        <AccordionItem>
          <AccordionItemToggle>Agreement to Arbitrate</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              This section applies to any dispute EXCEPT IT DOESNâ€™T INCLUDE A
              DISPUTE RELATING TO CLAIMS FOR INJUNCTIVE OR EQUITABLE RELIEF
              REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Kinguru's
              INTELLECTUAL PROPERTY RIGHTS. The term "dispute" means any
              dispute, action, or other controversy between you and Kinguru
        ...
        <AccordionItem>
          <AccordionItemToggle>Notice of Dispute</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              In the event of a dispute, you or Kinguru must give the other a
              ...
              You must send any Notice of Dispute via email to:Â [email
              protected]. Kinguru will send any Notice of Dispute to you by mail
              to your address if we have it, or otherwise to your email address.
              You and Kinguru will attempt to resolve any dispute through
              informal negotiation within sixty (60) days from the date the
              Notice of Dispute is sent. After sixty (60) days, you or Kinguru
              may commence arbitration.
            </p>
          </AccordionItemContent>
        </AccordionItem>
        <AccordionItem>
          <AccordionItemToggle>Binding Arbitration</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              If you and Kinguru don't resolve any dispute by informal
        ...
        <AccordionItem>
          <AccordionItemToggle>Submissions and Privacy</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              ...
              property of Kinguru without any compensation or credit to you
              whatsoever. Kinguru and its affiliates shall have no obligations
        ...
        <AccordionItem>
          <AccordionItemToggle>Promotions</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              Kinguru may, from time to time, include contests, promotions,
        ...
        <AccordionItem>
          <AccordionItemToggle>Typographical Errors</AccordionItemToggle>
          <AccordionItemContent>
            <p>
        ...
        <AccordionItem>
          <AccordionItemToggle>Miscellaneous</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              ...
              signed by an authorized representative of Kinguru. Kinguru will be
              ...
              breach or anticipatory breach by you. Kinguru operates and
              controls the Kinguru Service from its offices in . The Service is
              ...
              choose to access the Kinguru Service from other locations do so on
              ...
              Kinguru Privacy Policy) contains the entire understanding, and
              supersedes all prior understandings, between you and Kinguru
        ...
        <AccordionItem>
          <AccordionItemToggle>Disclaimer</AccordionItemToggle>
          <AccordionItemContent>
            <p>
              Kinguru is not responsible for any content, code or any other
              imprecision. Kinguru does not provide warranties or guarantees. In
              no event shall Kinguru be liable for any special, direct,
              ...
              Service at any time without prior notice. The Kinguru Service and
              its contents are provided "as is" and "as available" without any
              warranty or representations of any kind, whether express or
              implied. Kinguru is a distributor and not a publisher of the
              content supplied by third parties; as such, Kinguru exercises no
              ...
              accessible via the Kinguru Service. Without limiting the
              foregoing, Kinguru specifically disclaims all warranties and
              representations in any content transmitted on or in connection
              with the Kinguru Service or on sites that may appear as links on
              the Kinguru Service, or in the products provided as a part of, or
              otherwise in connection with, the Kinguru Service, including
              ...
              oral advice or written information given by Kinguru or any of its
              ...
              Kinguru does not warrant that the Kinguru Service will be
