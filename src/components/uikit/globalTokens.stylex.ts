...
export const globalTokens = stylex.defineVars({
  ...
  foregroundColor: { default: "#ffffff" },
  accentColor: { default: "#FFD800" },
  accentActiveColor: { default: "#FFEA00" },
  textOneColor: { default: "#212529" },
  textTwoColor: { default: "#AFAFAF" },
  textThreeColor: { default: "#F2F2F2" },
});
