...
export const createPremiseFormSchema = z.discriminatedUnion("formType", [
  z.object({
  ...
  z.object({
    ...
    parametersAndAmenities: parametersAndAmenitiesSchema,
  }),
  z.object({
    formType: z.literal(CreatePremiseFormTypeEnum.OpenHoursAndPrice),
    openHoursAndPrice: openHoursAndPriceSchema,
  }),
  z.object({
  ...
  z.object({
    ...
    bookingCancelTerm: bookingCancelTermSchema,
  }),
]);
